...
public class OwnedHouseListResponseDto {
    ...
    private Long totalOwnedPrice;  // 총 취득가격
    private Long totalCurrentPrice; // 총 평가가격
    private Long totalPriceDifference; // 총 취득가 대비 증감맥
    ...
    public static OwnedHouseListResponseDto from(List<OwnedHouseResponseDto> houseList) {
        ...
        return OwnedHouseListResponseDto.builder()
                ...
                .totalOwnedPrice(statsOwned.getSum())
                .totalCurrentPrice(statsCurrent.getSum())
                .totalPriceDifference(statsDiff.getSum())
